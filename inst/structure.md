...
## `src/ai_cctv/ai_server/client/chat_bot/chat_bot.py`
...
## `src/ai_cctv/ai_server/client/chat_bot/discord_bot.py`
...
## `src/ai_cctv/ai_server/client/crop_manager.py`
...
## `src/ai_cctv/ai_server/client/example_face_identifier.py`

| ?? | ?? | ??? | ??? | ?? ?? |
|---|---|---|---|---|
| `main` | main 함수의 주요 기능을 수행합니다. | None | ??? ?? ?? ?? | ?? ?? ?? |

## `src/ai_cctv/ai_server/client/face_identifier.py`
...
## `src/ai_cctv/ai_server/client/face_recognition.py`
...
## `src/ai_cctv/ai_server/client/full_body_checker.py`
...
## `src/ai_cctv/ai_server/client/person_state_manager.py`
...
## `src/ai_cctv/ai_server/client/person_tracker.py`
...
## `src/ai_cctv/ai_server/client/pipeline/person_frame_processor.py`
...
## `src/ai_cctv/ai_server/client/recording_manager.py`
...
## `src/ai_cctv/ai_server/client/settings_window.py`
...
## `src/ai_cctv/ai_server/client/storage/path_manager.py`
...
## `src/ai_cctv/ai_server/client/ui/event_presenter.py`
...
## `src/ai_cctv/ai_server/client/ui/main_window.py`
...
## `src/ai_cctv/ai_server/client/video_stream.py`
...
## `src/ai_cctv/ai_server/client/video_worker.py`
...
## `src/ai_cctv/ai_server/client/vlm_person_analyzer.py`

| ?? | ?? | ??? | ??? | ?? ?? |
|---|---|---|---|---|
| `PersonAnalyzer` | 운영 코드에서 사용할 인물 이미지 VLM 분석기입니다. | PersonAnalyzer ???? | ??? ?? ?? ?? | ??: QwenPersonAnalyzer |

## `src/ai_cctv/ai_server/client/vlm_person_analyzer_qwen.py`
...
## `src/ai_cctv/ai_server/client/vlm_person_analyzer_qwen_test.py`
...
## `src/ai_cctv/ai_server/client/vlm_worker.py`
